...
function verifyMobile() {
    ...
    validity = false; 
    messageText = message; 
    mobileBox.value = ""; // remove erroneous entry from input box 
	}
	finally { 
    mobileComplete = validity; 
